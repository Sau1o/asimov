# Usar um atalho para gravar a vox
# Transcrever o audio para texto em ptg -> Whisper
# De posse deste texto, jogar em uma LLM -> Agente
# De posse da resposta da LLM utilizar um modelo de TTS
